    ...
    <div className="min-h-screen px-5 pt-14 pb-24">
      <div className="flex items-center justify-between mb-6">
        ...
        <div className="flex gap-2">
          <button className="w-9 h-9 rounded-xl bg-card border border-border/50 flex items-center justify-center"><BookmarkPlus size={16} /></button>
          <button className="w-9 h-9 rounded-xl bg-card border border-border/50 flex items-center justify-center"><Share2 size={16} /></button>
        </div>
      </div>
      <img src={snap.imageUrl} alt="Scanned" className="w-full h-48 rounded-3xl object-cover mb-5 animate-fade-up" />
      <div className="bg-card rounded-3xl p-4 border border-border/50 mb-3 animate-fade-up" style={{ animationDelay: "80ms", animationFillMode: "both" }}>
      ...
      <div className="bg-primary/5 rounded-3xl p-4 border border-primary/10 mb-3 animate-fade-up" style={{ animationDelay: "160ms", animationFillMode: "both" }}>
      ...
      <div className="bg-card rounded-3xl p-4 border border-border/50 mb-5 animate-fade-up" style={{ animationDelay: "240ms", animationFillMode: "both" }}>
